...
Call log:
  - waiting for getByRole('textbox', { name: 'First Name' })
    ...
    at /Volumes/Projects/PROJECTS/2025/covergo/tests/page_object/PIM/PIMPageActions.ts:23:53
...
```ts
  ...
  17 |                await this.pimElements.addButton.click({ force: true });
  18 |           });
  19 |      }
  20 |
...
> 23 |              await  this.pimElements.firstNameInput.fill(testData.firstName);
  ...
  47 | }
  48 |
  49 | export default PIMPageActions;
```