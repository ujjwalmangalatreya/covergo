  ...
  - rowgroup:
    ...
    - row " 0441 FirstNameDVU LastNameAutoTest  ":
      ...
      - cell " ":
        - button ""
        - button ""
    - row " OtheIdTest FirstNTest MidNamTest LastNaTest HR Manager (Deleted) Full-Time Permanent Human Resources ":
      - cell "":
        - checkbox ""
        - text: 
      - cell "OtheIdTest"
      - cell "FirstNTest MidNamTest"
      - cell "LastNaTest"
      - cell "HR Manager (Deleted)"
