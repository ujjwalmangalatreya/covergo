...
Received object: {Symbol(async_id_symbol): 46218, Symbol(trigger_async_id_symbol): 44524, Symbol(kResourceStore): {"_asyncLocalStorage": {"enabled": true, "kResourceStore": Symbol(kResourceStore)}, "_data": Map {"stepZone" => {"attachmentIndices": [], "box": undefined, "boxedStack": undefined, "category": "test.step", "complete": [Function complete], "info": {"_stepId": "test.step@25", "_testInfo": [TestInfoImpl], "annotations": [Array]}, "location": {"column": 22, "file": "/Volumes/Projects/PROJECTS/2025/covergo/tests/page_object/PIM/PIMPageActions.ts", "function": "PIMPageActions.verifyNameInPersonalDetails", "line": 78}, "stepId": "test.step@25", "steps": [[Object], [Object]], "title": "Verify Name in personal details page"}}}}
